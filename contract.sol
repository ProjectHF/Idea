...
contract HiFreQ is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    mapping(address => uint256) public walletMints;

    address reserveWallet = payable(0x9E60a5C05D5a4B0895d07A35D515Fb2861D26127);

    string public uriPrefix = "";
    string public uriSuffix = "";

    uint256 public constant maxWalletMint = 32;
